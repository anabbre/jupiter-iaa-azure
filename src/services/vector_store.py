...
logger.info("Inicializando Qdrant Vector Store",request_id=request_id,source="data_processing")
try: 
    ...
    logger.debug("Configuración de Qdrant cargada",url=qdrant_url,collection_name=collection_name,request_id=request_id,source="data_processing")
    ...
    try:
        ...
        if not collection_exists:
            ...
            logger.info(f"Colección no encontrada",collection_solicitada=collection_name,colecciones_disponibles=available_collections,request_id=request_id,source="data_processing")
    ...
    logger.debug("Parámetros configurados",documentos_a_recuperar=n_docs,request_id=request_id,source="data_processing")
